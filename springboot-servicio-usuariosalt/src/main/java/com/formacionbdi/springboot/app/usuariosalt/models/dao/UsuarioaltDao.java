package com.formacionbdi.springboot.app.usuariosalt.models.dao;
...
import com.formacionbdi.springboot.app.usuariosalt.models.entity.Usuario;


@RepositoryRestResource(path="usuariosalt")
public interface UsuarioaltDao extends PagingAndSortingRepository<Usuario, Long>{
